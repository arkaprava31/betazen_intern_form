    ...
    const nextClicked = async () => {
        ...
        try {
          ...
          const response = await axios.post('http://localhost:5050/api/sendData', {
            ...
            // Modify the keys based on your server's expected data structure
            personalDetails: {
              name: state.input1,
              email: state.input2,
              phone: state.input3,
    ...
    return (
        <section>
            <div className="container" style={{ height: '100vh' }}>
                <div className="main">
                    <div className="ans scroll" style={{ height: '30rem' }}>
                        ...
                        <div className='box-info'>
                            ...
                            <div>
                                <div className="info1">
                                    ...
                                    {
                                        state.input5 ?
                                            <div className="data">{state.input5}</div> :
                                            <div className="data void">Field is empty!</div>
                                    }
                                </div>
                                <div className="info1">
                        ...
                        <div className='box-info'>
                            ...
                            {/* //CV */}
                            <div className="info1">
                                <div className="field">Uploaded Resume / CV:</div>
                                {
                                    state.fileInput ? 
                                        <div className='data'>
                                            {state.fileInput.name} (Size: {state.fileInput.size} bytes)
                                        </div>
